...
folder_model =  os.path.join(paramF.path_output, f'trained_model/{paramH.featureType}')
...
## 2.1. dataset
"""
list_entity = read_json2list(paramF.path_dataset_test)

"""## 2.2. prediction"""

ensemble_name = 'test_ensemble'
path_pred_caid = f'{ensemble_name}.json'
