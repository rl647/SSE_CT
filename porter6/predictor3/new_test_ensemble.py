...
folder_model =  '/home/runfeng/Dropbox/flow_topo/porter6/predictor3/output/trained_model/esm2'
...
## 2.1. dataset
"""
list_entity = read_json2list('/home/runfeng/Dropbox/flow_topo/data/test_data/test.json')
"""## 2.2. prediction"""

ensemble_name = '/home/runfeng/Dropbox/flow_topo/data/P6/output'
path_pred_caid = f'{ensemble_name}/test_out.json'
...
for entity in list_entity:
    entity_id = entity['id']
    # print(entity_id)
    if not os.path.exists(f'/home/runfeng/Dropbox/flow_topo/data/P6/esm2/{entity_id}.npy'):
        continue
...
os.system(f'python /home/runfeng/Dropbox/flow_topo/porter6/predictor3/json2csv3.py')
os.system(f'rm -rf /home/runfeng/Dropbox/flow_topo/data/P6/output/test_out.json')
os.system(f'rm -rf /home/runfeng/Dropbox/flow_topo/data/P6/esm2/*')
