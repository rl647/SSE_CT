...
def process_json_to_q3_csv(json_file_path):
    ...
    with open('/home/runfeng/Dropbox/flow_topo/data/P6/P6_predicted_ss.txt','a') as f:
...
# Example usage
json_file_path = '/home/runfeng/Dropbox/flow_topo/data/P6/output/test_out.json'  # Replace with your JSON file path
