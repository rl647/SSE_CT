...
class Net(nn.Module):
    def __init__(self, input_size):
        ...
        self.conv12 = nn.Conv1d(in_channels=self.conv11.out_channels, out_channels=8, kernel_size=3, stride=1, padding=1)
        
        self.conv13 = nn.Conv1d(in_channels=self.conv12.out_channels, out_channels=3, kernel_size=1, stride=1, padding=0) # out_channels should be the number of classes.
        self.tanh = nn.Tanh()
