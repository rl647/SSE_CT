...
# Example usage:
fasta_file = '/home/runfeng/Dropbox/flow_topo/data/test_data/test.fasta'
json_output = '/home/runfeng/Dropbox/flow_topo/data/test_data/test.json'
fasta_to_json(fasta_file, json_output)
